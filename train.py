...
if 1:
    ...
    desc += '-custom-images';     dataset = EasyDict(tfrecord_dir='custom-dataset');                 train.mirror_augment = True
...
#----------------------------------------------------------------------------
  # floyd run --gpu2 --env pytorch-1.0 --data wmreynol5/datasets/dataset/2:dataset "python3 train.py"
